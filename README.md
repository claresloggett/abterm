...
The organisation, project, and team can be found in the Azure Boards UI. Your usual URL for viewing, for instance, sprint listings, will contain these variables, in a form resembling 
